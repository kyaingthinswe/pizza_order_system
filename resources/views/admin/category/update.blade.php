                    ...
                    <div class="col-lg-6 offset-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="{{route('category_update')}}" method="post" novalidate="novalidate">
                                    @csrf
                                    <div class="form-group">
                                        <input type="hidden" value="{{$category->id}}" name="id">
                                        <label for="categoryName" class="control-label mb-1">Name</label>
                                        <input id="categoryName" value="{{old('categoryName',$category->name)}}" name="categoryName" type="text" class="form-control @error('categoryName')is-invalid @enderror" aria-required="true" aria-invalid="false" >
                                        @error('categoryName')
